...
Which can be used to call `insert-pair-edit' /
`insert-pair-edit-update' / `insert-pair-edit-delete' / etc... with
...
;; -------------------------------------------------------------------
;;;; `ipe-menu--*' menu KeyMaps.
;; -------------------------------------------------------------------

;; Edit -> Pairs Maps
(defvar ipe-menu--emacs-edit-pairs-map
  (make-sparse-keymap "Edit - Pairs")
...
(defvar ipe-menu--edit-pair-defns-map
  (make-sparse-keymap "Edit - Pairs - Edit PAIR Definitions")
...
(defvar ipe-menu--mode-map
  (make-sparse-keymap "Insert Pair Edit")
...
(defvar ipe-menu--insert-and-map
  (make-sparse-keymap "Insert Pair Edit - Insert And")
...
(defvar ipe-menu--movement-by-map
...
(defvar ipe-menu--edit-contents-map
  (make-sparse-keymap "Insert Pair Edit - Edit CONTENTS")
...
(defvar ipe-menu--next-prev-map
  (make-sparse-keymap "Insert Pair Edit - Next / Previous")
...
(defvar ipe-menu--multiple-map
  (make-sparse-keymap "Insert Pair Edit - Multiple")
...
Add a `'menu-item' that calls `insert-pair-edit' for the `ipe' PAIR
with the given MNEMONIC to KEYMAP."
  ...
  (define-key-after keymap
    ...
    (list 'menu-item
	  ...
	  (list 'lambda nil (list 'interactive)
		(list 'insert-pair-edit nil mnemonic))
	  :keys mnemonic
...
Which call `insert-pair-edit' with one of the current set of
...
MAJOR-MODE."
  ...
  (interactive)
  (let* ((pairs              (ipe--pairs major-mode))
	 (insert-pair-keymap (make-sparse-keymap "Insert PAIR")))
    (ipe-menu--sub-menu-keymap pairs
			       insert-pair-keymap
			       nil
...
Add a `'menu-item' that calls `insert-pair-edit-update' for the `ipe'
PAIR with the given MNEMONIC to KEYMAP."
  ...
  (define-key-after keymap
    ...
    (list 'menu-item
	  (ipe-menu--text mnemonic major-mode)
	  (list 'lambda nil (list 'interactive)
		(list 'insert-pair-edit-update mnemonic))
	  :keys mnemonic
...
Which will call `insert-pair-edit-update' with one of the current set
of `ipe-pairs' / `ipe-mode-pairs' PAIRs.
...
MAJOR-MODE."
  ...
  (interactive)
  (let ((pairs              (ipe--pairs major-mode))
	(update-pair-keymap (make-sparse-keymap "Update PAIR")))
    (ipe-menu--sub-menu-keymap pairs
			       update-pair-keymap
			       nil
...
Add a `'menu-item' that calls `insert-pair-edit-delete' for the `ipe'
PAIR with the given MNEMONIC to KEYMAP."
  ...
  (define-key-after keymap
    ...
    (list 'menu-item
	  (ipe-menu--text mnemonic major-mode)
	  (list 'lambda nil (list 'interactive)
		(list 'insert-pair-edit-delete mnemonic))
	  :keys mnemonic
...
Which will call `insert-pair-edit-delete' with one of the current set
of `ipe-pairs' / `ipe-mode-pairs' PAIRs.
...
MAJOR-MODE."
  ...
  (interactive)
  (let ((pairs              (ipe--pairs major-mode))
	(delete-pair-keymap (make-sparse-keymap "Delete PAIR")))
    (ipe-menu--sub-menu-keymap pairs
			       delete-pair-keymap
			       nil
...
MAJOR-MODE."
  ...
  (interactive)
  (let ((ipe-menu--edit-pair-defn
	 (make-sparse-keymap "Edit PAIR Definition")))
    (mapc
     (lambda (mnemonic)
       (define-key-after ipe-menu--edit-pair-defn
	 (vector (intern (concat "mnemonic-" mnemonic)))
...
MAJOR-MODE."
  ...
  (interactive)
  (let ((ipe-menu--edit-mode-pair-defn
	 (make-sparse-keymap "Edit Mode-Specific PAIR Definitions"))
	(mode major-mode))
    (mapc
     (lambda (mnemonic)
       (define-key-after ipe-menu--edit-mode-pair-defn
...
MAJOR-MODE."
  ...
  (interactive)
  (let ((ipe-menu--delete-pair-defn
	 (make-sparse-keymap "Delete PAIR Definition")))
    (mapc
     (lambda (mnemonic)
       (define-key-after ipe-menu--delete-pair-defn
	 (vector (intern (concat "mnemonic-" mnemonic)))
	 (list 'menu-item (ipe-menu--text mnemonic t)
	       (list 'lambda nil (list 'interactive)
...
MAJOR-MODE."
  ...
  (interactive)
  (let ((ipe-menu--delete-mode-pair-defn
	 (make-sparse-keymap "Delete Mode-Specific PAIR Definition"))
	(mode major-mode))
    (mapc
     (lambda (mnemonic)
       (define-key-after ipe-menu--delete-mode-pair-defn
	 (vector (intern (concat (symbol-name mode)
				 "-mnemonic-" mnemonic)))
	 (list 'menu-item (ipe-menu--text mnemonic mode)
	       (list 'lambda nil (list 'interactive)
...
MAJOR-MODE."
  ...
  (let ((pairs              (ipe--pairs major-mode))
	(change-pair-keymap
	 (make-sparse-keymap "Insert Pair Edit - Change PAIR")))
    (ipe-menu--sub-menu-keymap pairs
			       change-pair-keymap
			       nil
...
Sub-menu based upon the current buffers MAJOR-MODE."
  ...
  (define-key ipe-menu--emacs-edit-pairs-map [insert-pair]
	      (list 'menu-item "Insert PAIR"
		    ...
		    :keys (if (where-is-internal 'insert-pair-edit)
			      (substitute-command-keys "\\[insert-pair-edit]")
			    "")
...
Sub-menu based upon the current buffers MAJOR-MODE."
  ...
  (define-key-after ipe-menu--emacs-edit-pairs-map [update-pair]
    (list 'menu-item "Update PAIR"
	  ...
	  :keys (if (where-is-internal 'insert-pair-edit-update)
		    (substitute-command-keys "\\[insert-pair-edit-update]")
		  (if (where-is-internal 'insert-pair-edit)
...
Sub-menu based up on the current buffers MAJOR-MODE."
  ...
  (define-key-after ipe-menu--emacs-edit-pairs-map [delete-pair]
    (list 'menu-item "Delete PAIR"
	  ...
	  :keys (if (where-is-internal 'insert-pair-edit-delete)
		    (substitute-command-keys "\\[insert-pair-edit-delete]")
		  (if (where-is-internal 'insert-pair-edit)
		      (substitute-command-keys "\\[universal-argument]\
 \\[universal-argument] \\[insert-pair-edit]")
		    ""))
...
;; -------------------------------------------------------------------
;;;; Addition to the standard "Edit Menu"
;; -------------------------------------------------------------------

(defun ipe-menu--emacs-edit-pairs ()
...
Which will call `insert-pair-edit' / `insert-pair-edit-update' / or
`insert-pair-edit-delete' with one of the current set of `ipe-pairs' /
`ipe-mode-pairs' PAIRs.

This changes based upon the current buffers MAJOR-MODE."

  (interactive)
  (let ((ipe-menu--emacs-edit-pairs-map
	 (make-sparse-keymap "Pairs")))
    (define-key-after ipe-menu--emacs-edit-pairs-map [pairs--sep-1]
      '(menu-item "--" nil))
    (define-key-after ipe-menu--emacs-edit-pairs-map
      [pairs--pair-defns]
      (list 'menu-item "Edit PAIR Definitions"
	    ipe-menu--edit-pair-defns-map))
    (define-key-after ipe-menu--emacs-edit-pairs-map [pairs--sep-2]
      '(menu-item "--" nil))
    (define-key-after ipe-menu--emacs-edit-pairs-map [pairs--options]
      '(menu-item
	"Options" ipe-edit--options
	:help "Customize 'Insert Pair Edit' (ipe)."))
    (define-key-after ipe-menu--emacs-edit-pairs-map [pairs--info]
      '(menu-item
	"Info" ipe-help--info
	:help "Display the 'Insert Pair Edit' (ipe) info file."))
    (define-key-after ipe-menu--emacs-edit-pairs-map [pairs--help]
      '(menu-item
	"Help" ipe-help
	:help "Display the 'Insert Pair Edit' (ipe) help."))
    ipe-menu--emacs-edit-pairs-map))

(setq ipe-menu--emacs-edit-pairs-map (ipe-menu--emacs-edit-pairs))
...
updated according to the current buffers MAJOR-MODE."
  ...
  (condition-case nil
    ...
    (t (message "Error updating `ipe' menus."))))
...
(define-key-after ipe-menu--insert-and-map [goto-open]
  '(menu-item
...
(define-key-after ipe-menu--insert-and-map [goto-close]
  '(menu-item
...
(define-key-after ipe-menu--insert-and-map [resume]
  '(menu-item
...
(define-key-after ipe-menu--insert-and-map [sep-1]
  '(menu-item "--" nil)
  'resume)

(define-key-after ipe-menu--insert-and-map [copy-text]
  '(menu-item
...
(define-key-after ipe-menu--insert-and-map [kill-text]
  '(menu-item
...
(define-key-after ipe-menu--movement-by-map [line]
  '(menu-item
...
(define-key-after ipe-menu--movement-by-map [list]
  '(menu-item
...
(define-key-after ipe-menu--edit-contents-map [kill]
  '(menu-item
    "Kill" ipe-edit--contents-kill
    :help "Kill the text enclosed by the 'Insert Pair Edit' (ipe)\
 OPEN and CLOSE."))

(define-key-after ipe-menu--edit-contents-map [copy]
  '(menu-item
...
(define-key-after ipe-menu--edit-contents-map [paste]
  '(menu-item
...
(define-key-after ipe-menu--edit-contents-map [replace]
  '(menu-item
...
(define-key-after ipe-menu--edit-contents-map [sep-1]
  '(menu-item "--" nil)
  'replace)

(define-key-after ipe-menu--edit-contents-map [trim]
  '(menu-item
...
(define-key-after ipe-menu--edit-contents-map [upcase]
  '(menu-item
...
(define-key-after ipe-menu--edit-contents-map [capitalize]
  '(menu-item
...
(define-key-after ipe-menu--edit-contents-map [downcase]
  '(menu-item
...
(define-key-after ipe-menu--next-prev-map [next-pair]
  '(menu-item
...
(define-key-after ipe-menu--next-prev-map [next-contents]
  '(menu-item
...
(define-key-after ipe-menu--next-prev-map [next-open]
  '(menu-item
...
(define-key-after ipe-menu--next-prev-map [next-close]
  '(menu-item
...
(define-key-after ipe-menu--next-prev-map [sep-1]
  '(menu-item "--" nil)
  'next-close)

(define-key-after ipe-menu--next-prev-map [previous-pair]
  '(menu-item
...
(define-key-after ipe-menu--next-prev-map [previous-contents]
  '(menu-item
...
(define-key-after ipe-menu--next-prev-map [previous-open]
  '(menu-item
...
(define-key-after ipe-menu--next-prev-map [previous-close]
  '(menu-item
...
(define-key ipe-menu--multiple-map [add-pair]
	    '(menu-item
	      "Add PAIR (At Point) " insert-pair-edit
	      :help "Add another 'Insert Pair Edit' (ipe) PAIR to the\
 buffer at POINT."))

(define-key-after ipe-menu--multiple-map [add-pair-forward]
  '(menu-item
...
(define-key-after ipe-menu--multiple-map [add-pair-backward]
  '(menu-item
...
(define-key-after ipe-menu--multiple-map [add-contents-forward]
  '(menu-item
...
(define-key-after ipe-menu--multiple-map [add-contents-backward]
  '(menu-item
...
(define-key-after ipe-menu--multiple-map [sep-1]
  '(menu-item "--" nil)
  'add-contents-backward)

(define-key-after ipe-menu--multiple-map [delete-first-pair]
  '(menu-item
...
(define-key-after ipe-menu--multiple-map [delete-last-pair]
  '(menu-item
...
(define-key ipe-menu--edit-pair-defns-map [add-pair]
	    (list 'menu-item
		  "Add PAIR Definition..."
...
(define-key-after ipe-menu--edit-pair-defns-map [ipe-add-pair]
  (list 'menu-item
	"Add PAIR Definition..."
	(lambda () (interactive) (ipe-defn--ui-add-pair))
	:keys (if (where-is-internal 'ipe-defn--edit-pair ipe-edit-mode-map)
...
(define-key-after ipe-menu--edit-pair-defns-map [add-mode-pair]
  (list 'menu-item
...
;; 2nd copy for `ipe-edit-mode' key-bindings.
(define-key-after ipe-menu--edit-pair-defns-map [ipe-add-mode-pair]
  (list 'menu-item
	"Add Mode-Specific PAIR Definition..."
	(lambda () (interactive) (ipe-defn--ui-add-mode-pair))
	:keys (if (where-is-internal 'ipe-defn--edit-pair ipe-edit-mode-map)
...
(define-key-after ipe-menu--edit-pair-defns-map [sep-1]
  '(menu-item "--" nil)
  'ipe-add-mode-pair)
...
(define-key-after ipe-menu--edit-pair-defns-map [sep-2]
  '(menu-item "--" nil)
  'ipe-edit-mode-pair-mnemonic-defn)
...
(define-key-after ipe-menu--edit-pair-defns-map [sep-3]
  '(menu-item "--" nil)
  'ipe-delete-mode-pair-defn-)
...
(define-key ipe-menu--mouse-map [ipe-mouse-insert]
	    '(menu-item
...
(define-key-after ipe-menu--mouse-map [ipe-mouse-ia]
  (list 'menu-item "Insert And" ipe-menu--insert-and-map)
  'ipe-mouse-insert)

(define-key-after ipe-menu--mouse-map [ipe-mouse-sep-1]
  '(menu-item "--" nil)
  'ipe-mouse-ia)

(define-key-after ipe-menu--mouse-map [ipe-mouse-delete-pair]
...
(define-key-after ipe-menu--mouse-map [ipe-mouse-edit-contents]
  (list 'menu-item "Edit CONTENTS" ipe-menu--edit-contents-map)
  'ipe-mouse-edit-pair)

(define-key-after ipe-menu--mouse-map [ipe-mouse-next-prev]
  (list 'menu-item "Next / Previous" ipe-menu--next-prev-map)
  'ipe-mouse-edit-contents)

(define-key-after ipe-menu--mouse-map [ipe-mouse-sep-2]
  '(menu-item "--" nil)
  'ipe-mouse-next-prev)

(define-key-after ipe-menu--mouse-map [ipe-mouse-abort]
  '(menu-item
...
(define-key-after ipe-menu--mouse-map [ipe-mouse-help]
  '(menu-item
...
;; Insert Commands.
(define-key-after ipe-menu--mode-map [insert-pair]
  '(menu-item
    "Insert PAIR" ipe-edit--insert-pair
    :help "Insert the 'Insert Pair Edit' (ipe) OPEN and CLOSE into\
 the buffer, and exit 'ipe-edit-mode'."))

(define-key-after ipe-menu--mode-map [insert-and]
  (list 'menu-item "Insert And" ipe-menu--insert-and-map)
  'insert-pair)

(define-key-after ipe-menu--mode-map [sep-1]
  '(menu-item "--" nil)
  'insert-and)

;; OPEN Movement.
(define-key-after ipe-menu--mode-map [open-beg]
  '(menu-item
...
(define-key-after ipe-menu--mode-map [open-up]
  '(menu-item
...
(define-key-after ipe-menu--mode-map [open-backward]
  '(menu-item
...
(define-key-after ipe-menu--mode-map [open-forward]
  '(menu-item
...
(define-key-after ipe-menu--mode-map [open-down]
  '(menu-item
...
(define-key-after ipe-menu--mode-map [open-end]
  '(menu-item
...
;; CLOSE Movement.
(define-key-after ipe-menu--mode-map [sep-2]
  '(menu-item "--" nil)
  'open-end)

(define-key-after ipe-menu--mode-map [close-beg]
  '(menu-item
...
(define-key-after ipe-menu--mode-map [close-up]
  '(menu-item
...
(define-key-after ipe-menu--mode-map [close-backward]
  '(menu-item
...
(define-key-after ipe-menu--mode-map [close-forward]
  '(menu-item
...
(define-key-after ipe-menu--mode-map [close-down]
  '(menu-item
...
(define-key-after ipe-menu--mode-map [close-end]
  '(menu-item
...
(define-key-after ipe-menu--mode-map [sep-3]
  '(menu-item "--" nil)
  'close-end)
...
(define-key-after ipe-menu--mode-map [change-movement]
  (list 'menu-item "Change Movement" ipe-menu--movement-by-map)
  'change-pair)

(define-key-after ipe-menu--mode-map [edit-contents]
  (list 'menu-item "Edit CONTENTS" ipe-menu--edit-contents-map)
  'change-movement)

(define-key-after ipe-menu--mode-map [next-prev]
  (list 'menu-item "Next / Previous" ipe-menu--next-prev-map)
  'edit-contents)

(define-key-after ipe-menu--mode-map [multiple]
  (list 'menu-item "Multiple" ipe-menu--multiple-map)
  'next-prev)

(define-key-after ipe-menu--mode-map [sep-4]
  '(menu-item "--" nil)
  'multiple)

(define-key-after ipe-menu--mode-map [toggle-escapes]
  '(menu-item
    "Show ESCAPES"
...
(define-key-after ipe-menu--mode-map [edit-pair-defns]
  (list 'menu-item
	"Edit PAIR Definitions"
	ipe-menu--edit-pair-defns-map)
  'toggle-escapes)

(define-key-after ipe-menu--mode-map [sep-5]
  '(menu-item "--" nil)
  'edit-pair-defns)

(define-key-after ipe-menu--mode-map [abort]
  '(menu-item
    "Abort" ipe-edit--abort
    :help "Exit 'ipe-edit-mode' without inserting OPEN and CLOSE to\
 the buffer.")
...
(define-key-after ipe-menu--mode-map [options]
  '(menu-item
    "Options" ipe-edit--options
    :help "Customize 'Insert Pair Edit' (ipe).")
  'abort)

(define-key-after ipe-menu--mode-map [info]
  '(menu-item
    "Info" ipe-help--info
    :help "Display the 'Insert Pair Edit' (ipe) info file.")
  'options)

(define-key-after ipe-menu--mode-map [help]
  '(menu-item
    "Help" ipe-help--mode-help
    :help "Display the 'Insert Pair Edit' (ipe) help.")
  'info)
